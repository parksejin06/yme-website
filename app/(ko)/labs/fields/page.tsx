          ...
          {RESEARCH_FIELDS.map((field, i) => (
            <ScrollReveal key={field.key} delayMs={i * 90}>
              ...
              >
                ...
                <div className="p-5">
                  <p className="font-display text-lg font-bold text-ink">{fieldLabel(field.key, "ko")}</p>
                  <p className="mt-2 text-sm leading-relaxed text-ink/70">{FIELD_DESCRIPTIONS[field.key]?.ko}</p>

  ...
  return (
    <>
      <PageHero
        ...
        image="/images/new_mainbg/대학원_new.png"
      ...
      <section className="mx-auto max-w-content px-4 py-16 sm:px-6 sm:py-20">
        <div className="grid gap-10 md:grid-cols-[1.15fr_1fr] md:items-center md:gap-16">
          ...
          {/* CAD 설계 장면 — 프레임 없이 배경에 스며드는 소프트 마스크 +
              오른쪽 여백 방향으로 살짝 흘러나가는 비대칭 배치 */}
          <ScrollReveal delayMs={100}>
            <ParallaxImage className="aspect-[4/3] md:-mr-8 lg:-mr-14" strength={20}>
              <Image
                src="/images/redesign_image/thisisengineering-83udtzyaTS4-unsplash.jpg"
                alt="CAD 소프트웨어로 차량 섀시를 설계하는 엔지니어"
                fill
            ...
            {gradRequirements.programs.map((p) => (
              <div key={p.key} className="py-4 sm:px-5 sm:py-4 sm:first:pl-0">
                ...
                <p className="mt-1 font-display text-xl font-bold text-primary">
                  최소 {p.credits}
                  <span className="text-sm font-normal text-ink/60">학점</span>
                </p>
              </div>
            ))}
          </div>

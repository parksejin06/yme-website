        ...
        <div className="mx-auto max-w-content px-[var(--page-gutter)]">
          <ScrollReveal className="grid grid-cols-2 gap-y-12 divide-primary/15 md:grid-cols-4 md:gap-y-0 md:divide-x">
            ...
            <div className="pl-6 md:px-8">
              <StatCounter icon="/images/메인_연구실.png.png" value={labs.length} label="Research labs" />
            </div>
            <div className="pr-6 md:px-8">
              <StatCounter icon="/images/메인_전문연구분야.png.png" value={6} label="Research fields" />
            </div>
            <div className="pl-6 md:pl-8">
              <StatCounter icon="/images/메인_네트워크.png.png" value={10} label="Industry-Academia Partnerships" />
            </div>
          </ScrollReveal>
        </div>
      </section>

    ...
    <>
      ...
      <section className="py-20 sm:py-28">
        <div className="mx-auto max-w-content px-4 sm:px-6">
          <ScrollReveal>
            <h2 className="text-balance font-display text-2xl text-ink sm:text-3xl">Explore</h2>
          </ScrollReveal>
        </div>

        <div className="mt-10">
          <ImageAutoSlider lang="en" />
        </div>
      </section>
      ...
      <section className="mx-auto max-w-content px-4 py-20 sm:px-6 sm:py-28">
        <div className="flex items-center justify-between">
          <ScrollReveal>
            <h2 className="text-balance font-display text-2xl text-ink sm:text-3xl">News</h2>
          </ScrollReveal>
          <Link href="/en/news" className="text-sm font-body text-primary">
            View all →
          </Link>
        </div>
        <ul className="mt-8 divide-y divide-line border-y border-line">
          {recentNotices.map((n) => (
            <li key={n.id} className="flex items-center justify-between gap-4 py-4">
              <Link href={postHref("en", "notices-undergraduate", n.sourcePostId)} className="flex min-w-0 items-center gap-2 hover:text-primary">
                {n.isPinned && (
